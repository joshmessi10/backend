...
const connection =
  "mongodb+srv://testDatabaseDP2:testDatabasePW@cluster0.1kkmj.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0";
...
app.post(
  ...
  [
    ...
    body("password")
      ...
      .withMessage(
        "La contraseña no es segura, debe tener al menos una mayúscula, minúscula, número y símbolo"
      ),
    body("telefono")
      .notEmpty()
  ...
  async (req, res) => {
    ...
    if (!errores.isEmpty()) {
      ...
      return res
        .status(400)
        .json({ error: "Error de validación", detalles: errorMessages });
    }

    const { nombre_usuario, apellido_usuario, email, password, telefono } =
      req.body;
...
app.post(
  ...
  [
    ...
    body("nombre_billetera")
      .notEmpty()
      .withMessage("nombre_billetera es requerido"),
  ],
  async (req, res) => {
    const errores = validationResult(req);
    if (!errores.isEmpty()) {
...
app.post(
  ...
  [
    ...
    body("lectura_sensor")
      .isNumeric()
      .withMessage("lectura_sensor debe ser un número"),
  ],
  async (req, res) => {
    const errores = validationResult(req);
    if (!errores.isEmpty()) {
...
app.post(
  ...
  [
    ...
    body("tipo_evento")
      .isIn(["acceso_no_autorizado", "caida_detectada", "desconexion", "null"])
      .withMessage("tipo_evento es inválido"),
    body("nivel_bateria")
      .isNumeric()
      .withMessage("nivel_bateria debe ser un número"),
    body("id_geolocalizacion")
      .notEmpty()
      .withMessage("geolocalizacion es requerida"),
  ],
  async (req, res) => {
    const errores = validationResult(req);
    if (!errores.isEmpty()) {
...
app.post(
  ...
  [
    body("tipo_conexion")
      .isBoolean()
      .withMessage(
        "tipo_conexion debe ser un booleano (1 para conexión, 0 para desconexión)"
      ),
    body("id_billetera").notEmpty().withMessage("id_billetera es requerido"),
    body("nivel_bateria")
      .isNumeric()
    ...
    body("distancia")
      .optional()
      .isNumeric()
      .withMessage("distancia debe ser un número si se proporciona"),
  ],
  async (req, res) => {
    const errores = validationResult(req);
    if (!errores.isEmpty()) {
...
app.post(
  ...
  [
    ...
    body("modo_alerta")
      .optional()
      .isIn(["silencio", "vibración", "sonido"])
      .withMessage('modo_alerta debe ser "silencio", "vibración" o "sonido"'),
    body("umbral_sensibilidad_acl_g")
      .optional()
      .isNumeric()
      .withMessage("umbral_sensibilidad_acl_g debe ser un número"),
    body("desbloqueo_remoto")
      .optional()
      .isBoolean()
      .withMessage("desbloqueo_remoto debe ser un booleano"),
    body("alerta_sonora")
      .optional()
      .isBoolean()
      .withMessage("alerta_sonora debe ser un booleano"),
  ],
  async (req, res) => {
    const errores = validationResult(req);
    if (!errores.isEmpty()) {
...
app.post(
  ...
  [
    ...
    body("tipo_notificacion")
      .notEmpty()
      .withMessage("tipo_notificacion es requerido"),
    body("contenido_notificacion")
      .notEmpty()
      .withMessage("contenido_notificacion es requerido"),
  ],
  async (req, res) => {
    const errores = validationResult(req);
    if (!errores.isEmpty()) {
...
app.post(
  "/respaldo",
  [
    body("tamaño_respaldo")
      .isNumeric()
      .withMessage("tamaño_respaldo debe ser un número"),
    body("estado_respaldo")
      .isBoolean()
      .withMessage("estado_respaldo debe ser un booleano"),
...
app.post(
  ...
  [
    body("id_billetera")
      .notEmpty()
      .withMessage("id_billetera es requerido")
      .isMongoId()
      .withMessage("id_billetera debe ser un ObjectId válido"),
    body("nivel_bateria")
      .isNumeric()
      .withMessage("nivel_bateria debe ser un número"),
    body("estado_cargando")
      .isBoolean()
      .withMessage("estado_cargando debe ser un booleano"),
  ],
  async (req, res) => {
    const errores = validationResult(req);
    if (!errores.isEmpty()) {
...
app.post(
  ...
  [
    body("id_usuario")
      ...
      .isMongoId()
      .withMessage("id_usuario debe ser un ObjectId válido"),
    body("id_billetera")
      .notEmpty()
      .withMessage("id_billetera es requerido")
      .isMongoId()
